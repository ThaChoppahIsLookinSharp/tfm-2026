...
levels (1st technology independent + 2nd technology dependent) in
...
The ONNX workload is a central input of the flow as seen in Figure~\ref{fig:talos-input-output}. Talos reads the operand precision directly
