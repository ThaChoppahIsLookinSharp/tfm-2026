...
the reports of the four synthesized configurations are reproduced in
Appendix~\ref{app:synthesis_reports}.

\subsection{Summary of the chapter}
\todo[inline]{Unificar refs a milestones en este summary: "third/fourth
milestone" -> Milestone~\ref{milestone:m3} / Milestone~\ref{milestone:m4},
y "The milestone M1" -> "Milestone M1", como en Project Development}
