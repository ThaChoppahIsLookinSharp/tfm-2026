...
The planned methodology can be summarized through several development
phases. This section only defines the role of each phase in the
process. The concrete decisions taken during the project are
described in the following chapter.

\begin{enumerate}
\item \textbf{Requirements analysis.} In this phase, the problem is
defined, the objectives detailed, and the limits of the work. Its main output
is the specification of the DNN input file (in ONNX format) and a set of requirements (performance parameters,....) that makes the rest of the development less
ambiguous.
...
most promising candidates through abstract hardware IP models. Both
were designed to use a NSGA-II algorithm to explore the space of
solutions.
