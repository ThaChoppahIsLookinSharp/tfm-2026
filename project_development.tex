...
This section presents the current development of the project. The previous chapters described the methodology. In this chapter, the focus is how the tool was developed: what has been implemented, how the different parts are connected, and what can currently be evaluated.

The aportation of the thesis is Talos, a Python tool for hierarchical design space exploration of DNN accelerators. At the current stage, Talos is not an RTL generator. Instead, it provides a modular software structure that allows candidate accelerator architectures to be generated, evaluated at an architectural level, and later translated into a more hardware-oriented representation based on abstract IP blocks.
