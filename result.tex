...
This section presents the current result of the project. The previous chapter described the methodology followed during development. In this chapter, the focus is the tool itself: what has been implemented, how the different parts are connected, and what can currently be evaluated.
