...
estimation is close to the synthesized implementations and power
estimation remains sufficiently accurate to guide the exploration. The
FP16 case shows a larger deviation, demonstrating that the precision
of the Level~2 model depends on the characteristics of the IPs being
combined. The model is therefore informative enough to reduce and rank
the design space, but it does not replace synthesis or physical
implementation of the final candidates.
